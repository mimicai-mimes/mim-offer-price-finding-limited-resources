...
<product_not_found>
<automatic_strategy>
- Однократный последовательный проход по ВСЕМ источникам по приоритетам
- Каждый источник проверяется ОДИН РАЗ - без повторных заходов
...
- Завершить поиск только когда:
  * Найдено 3 цены (успех, завершить досрочно)
  * ИЛИ проверены ВСЕ 19 доступных источников ОДИН РАЗ (сохранить то, что нашли: 0/1/2 цен)
